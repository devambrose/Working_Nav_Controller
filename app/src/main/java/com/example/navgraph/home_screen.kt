...
class home_screen : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            Log.e("apptest",it.getInt("testId").toString())
        }
    }
    ...
    override fun onCreateView(
        ...
        viewModel= ViewModelProvider.AndroidViewModelFactory(requireActivity().application).create(SharedViewModel::class.java)
